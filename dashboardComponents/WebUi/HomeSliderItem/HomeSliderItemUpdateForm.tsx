...
import GetHomeSliderItemForUpdateType from "@/types/WebUI/HomeSliderItem/GetHomeSliderItemForUpdateType";
import { signOut, useSession } from "next-auth/react";
import { useRouter } from "next/navigation";
import { useEffect, useRef, useState } from "react";
import Swal from "sweetalert2";

const HomeSliderItemUpdateForm: React.FC<{params:{lang:Locale,apiDomen:string|undefined,id:string}}> = ({params:{lang,apiDomen,id}}) => {
...
form.append("Id",id)
        ...
        fetch(`${apiDomen}api/HomeSliderItem/UpdateHomeSliderItem`, {
            method: 'PUT',
            headers: {
...
<ProductAddedImage apiDomen={apiDomen??"https://localhost:7115/"} Photo={null}  CurrentPictureUrl={Data?.response.imageUrl} onPhotoDelete={NewPhotoDelete}/>
...
export default HomeSliderItemUpdateForm;