...
const CreateCuponForSubCategoryForm:React.FC<{params:{lang:Locale,apiDomen:string|undefined}}> = ({params:{lang,apiDomen}}) => {
    ...
    const [SubCategories, SetSubCategories] = useState<Result<GetSubCategoryForUI[]>|null>(null);
...
function NumberInputCheckedValue(e: ChangeEvent<HTMLInputElement>) {
    ...
    function HandleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        fetch(`${apiDomen}api/Cupon/AddSpecificCuponForSubCategory`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'LangCode': `${lang}`, 
...
if (res.isConfirmed) {
    ...
    return(  <form id="addCuponForm" onSubmit={HandleSubmit}>
        <div className="grid grid-cols-4 gap-6 mb-6">
            ...
            <div className="col-span-4 border-2 border-gray-200 border-dashed rounded-lg p-4">
            <label htmlFor="subCtegoryId" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an Categories</label>
  <select name="subCategoryId" id="subCtegoryId" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
   {
