...
<nav className="fixed top-0 z-50 w-full bg-white border-b border-gray-200">
  <div className="px-3 py-3 lg:px-5 lg:pl-3">
    <div className="flex items-center justify-between">
      <div className="flex items-center justify-start rtl:justify-end">
        <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="inline-flex items-center p-2 text-sm text-black rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
  ...
  } ease-in-out duration-500 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow`}
  id="dropdown-user"
  style={{
    position: "absolute",
    right: "20px",
   ...
   <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      ...
      <li>
            ...
            <ul id="dropdown-example" className={`${isCategoryDropDown?"":"hidden"} py-2 space-y-2`}>
                  <li>
                     <Link href="/dashboard/category" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">ALL Categories</Link>
                  </li>
                  <li>
