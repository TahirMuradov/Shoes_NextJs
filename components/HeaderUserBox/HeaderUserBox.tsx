            ...
            <div className="flex items-center ms-3">
              <div>
                <button onClick={()=>setUserDropdownOpen(!isUserDropdownOpen)} type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                  ...
                  <Image width={100} height={100} className="w-8 h-8 rounded-full" src={user.user.image} alt="user photo"/>
                </button>
              </div>
              <div
  ...
  >
                ...
                <ul className="py-1" role="none">
                  ...
                  user.user.role === 'admin' ? ( <li>
                    <Link href="/dashobard" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Dashboard</Link>
                  </li>):(<></>)
                    }
